  ...
  return (
    <main className="min-h-screen bg-[#FAF9F6] text-stone-800 p-4 md:p-8 font-[family-name:var(--font-inter)] selection:bg-[#E8C8C8] selection:text-stone-900">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div
          ref={resultRef}
          className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-8 border-t border-stone-200/60 scroll-mt-6"
        >
          ...
          <div className="lg:col-span-2 flex flex-col">
            <div className="flex items-center gap-3 mb-6 pt-2">
              <span className="w-1.5 h-6 bg-[#D08B8B] rounded-full block"></span>
              <h2 className="text-lg font-[family-name:var(--font-playfair)] font-semibold text-stone-800">
                Vũ Trụ Liên Kết
              </h2>
            </div>
